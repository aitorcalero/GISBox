...
def CreateFolderStructure(_user):
    ...
    for root_folder_item in root_folder_items:
        if root_folder_item.type in file_types:
            ...
            file_destination = os.path.normpath(arcgisboxdir + '/' + root_folder_item.title + "." + file_extension)
    ...
    for fld in flds:
        ...
        logging.info('Name: {}\n'.format(fld['title']))
        os.mkdir(os.path.normpath( arcgisboxdir + "/" + fld['title']))
        ...
        for i in flds:
            if i.type in file_types:
                ...
                file_extension = item_path.rsplit(".",maxsplit=1)[1]
                file_destination = os.path.normpath(arcgisboxdir +"/"+ fld['title'] + "/" + i.title + "." + file_extension)
